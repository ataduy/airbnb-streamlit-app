...
# Sayfa başlığı
st.set_page_config(page_title="📊 Özellik Etkisi Paneli", layout="wide")
st.title("📊 Özelliklerin Fiyata Etkisi (Detaylı Görsel Analiz)")

# CSV yolu
csv_path = "/Users/atakandogulu/Desktop/airbnb_streamlit_app/model/model/feature_importance.csv"
