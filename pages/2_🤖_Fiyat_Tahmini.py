...
# Sayfa başlığı
st.set_page_config(page_title="💸 Fiyat Tahmini", layout="centered")
st.title("💸 Airbnb Fiyat Tahmini Aracı")

# 🎯 Model yükle
model_path = "/Users/atakandogulu/Desktop/airbnb_streamlit_app/model/model/price_model.pkl"
...
price_per_accommodate = 0  # Tahmin yapıldığı için bilinmiyor
price_per_bed = 0  # Aynı şekilde bilinmiyor
